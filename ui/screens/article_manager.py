...
class ArticleManager(ctk.CTkFrame):
    ...
    def __init__(self, parent, **kwargs):
        ...
        self.theme_colors = COLORS["light"]  # Par défaut, thème clair
    ...
    def _create_article_table(self) -> ttk.Treeview:
        ...
        style.map(
            'Treeview',
            background=[('selected', self.theme_colors["table_selected"])],
